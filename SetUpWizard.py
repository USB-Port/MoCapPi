...
#
#What Can I do here:
#   This class can not do much at the current moment, it is a place holder class that will hopefully handle what I described
#   above. Most of the code here is auto generated by QT Designer.
#
#
#What needs to be done in this class:
#   A LOT. Pretty much everythin I descibed in what the class is for, is not done. I started this but then started working
#   on other things. To Progress it will be best to create a new Widget GUI in QT Designer so that adding the new feature
#   that I desicrbed is easier to do. What I mean by that is, you can programmed the wizard without having a solid GUI.
#   There was a issue I will explain below
#
#What Happen here, it looks bad:
#   I was attempting to have a "Welcome screen" then have the user click next. Upon hitting Next, I wanted to change the
#   gridLayout and delete some inner widgers (Inner widgets like the Mario Pic, buttons, texts) But I was getting a
#   PyQT error upon doing this, something about can't add stuff to layput. So I tried to delete everything, then add in the stuff
#   Via code,  but it didn't work, just some weird X thing. I did not give up, but needed to work on something else.
#
################################################################################
